  ...
  <div>
    ...
    <div class="mt-5">
      ...
      <div class="bg-white p-4">
        <div v-if="filters.type !== 'PAYOUTS'" class="form-row">
        ...
        <div v-if="filters.type === 'REFUNDS'" class="form-row pt-3">
          <div class="form-check form-check-inline">
      ...
      <div class="list-group mt-4">
        <div v-for="item in items" :key="item.id">
          <transaction :item="item" v-on:child-action="updateResults"></transaction>
        </div>
      </div>
